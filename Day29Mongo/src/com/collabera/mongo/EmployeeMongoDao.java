...
public class EmployeeMongoDao {
	...
	public void connectToMongo() {
		...
		database = mongoClient.getDatabase("mydb").withCodecRegistry(pojoCodecRegistry);
	...
	public void updateEmployee(Employee emp) {
		UpdateResult updateResult = collection.updateOne(Filters.eq("_id", emp.getId()), Updates.combine(
...
//		dao.insertEmployee(new Employee( "Ada", "Smith", 28));
//		dao.insertEmployee(new Employee( "Martha", "Jones", 52));
...
//		dao.updateEmployee(new Employee(new ObjectId("5dd812d949e147650fc8aa30"), "Mary", "Jones", 33));
		
//		System.out.println("----------Delete Employee-----------");
//		dao.deleteEmployee(new ObjectId("5dd812eb71a7c9325c530fa6"));
//		dao.deleteEmployee(new ObjectId("5dd812eb71a7c9325c530fa7"));
//		dao.deleteEmployee(new ObjectId("5dd812eb71a7c9325c530fa8"));
//		dao.deleteEmployee(new ObjectId("5dd812fdbf409642b69edbc9"));
//		dao.deleteEmployee(new ObjectId("5dd812febf409642b69edbca"));
//		dao.deleteEmployee(new ObjectId("5dd812febf409642b69edbcb"));
